...
var OptionsMenu = Class.create({
	...
	initialize: function() {
		Event.observe(window, 'load', function(){
			var toolbarGroup = $$('#options-menu')[0];
			...
			$$('#options-menu li a').each(function(element) {
				Event.observe(element, 'click', this.optionClick.bind(this));
			}.bindAsEventListener(this));
			$$('#options-menu li li').each(function(element) {
				Event.observe(element, 'mouseover', this.optionHover.bind(this));
			}.bindAsEventListener(this));
		}.bindAsEventListener(this));
	},
...
var TYPO3BackendTVOptionsMenu = new OptionsMenu();

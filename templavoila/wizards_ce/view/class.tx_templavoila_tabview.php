 ...
 *
 * $Id: class.tx_templavoila_tabview.php 16722 2009-02-06 19:40:34Z dmitry $
 */
				...
				if ($this->enableFavoritesLink) {
					$favLink = '<a href="javascript:void(0)" title="' . $favTitle . '">' .
						'<img ' . t3lib_iconWorks::skinImg($GLOBALS['BACK_PATH'],
							...
							'wizards_ce/images/add_favorite.png') . ' vspace="5" alt="' .
							$favTitle . '" />' .
						'</a>';
				}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/view/class.tx_templavoila_tabbase.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/view/class.tx_templavoila_tabbase.php']);
}

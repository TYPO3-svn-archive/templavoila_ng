 ...
 *
 * $Id: index.php 16722 2009-02-06 19:40:34Z dmitry $
 */
...
require_once(t3lib_extMgm::extPath('templavoila', 'wizards_ce/tabs/class.tx_templavoila_basetab.php'));
require_once(t3lib_extMgm::extPath('templavoila', 'wizards_ce/model/class.tx_templavoila_contentelementdescriptor.php'));
require_once(t3lib_extMgm::extPath('templavoila', 'wizards_ce/view/class.tx_templavoila_tabview.php'));
...
class tx_templavoila_newcewizard {
	...
	protected function init() {
		...
		$GLOBALS['LANG']->includeLLFile('EXT:templavoila/wizards_ce/locallang.xml');
...
/*
			'favorites' => array(
				...
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_favoritestab.php',
				'class' =>  'tx_templavoila_favoritestab'
			),
*/
			'recent' => array(
				'title' => 'newcewizard.recent',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_recenttab.php',
				'class' =>  'tx_templavoila_recenttab'
			),
			'standard' => array(
				'title' => 'newcewizard.standard',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_standardelementstab.php',
				'class' =>  'tx_templavoila_standardelementstab'
			),
			'menus' => array(
				'title' => 'newcewizard.menus',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_menutab.php',
				'class' =>  'tx_templavoila_menutab'
			),
			'forms' => array(
				'title' => 'newcewizard.forms',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_formstab.php',
				'class' =>  'tx_templavoila_formstab'
			),
			'fce' => array(
				'title' => 'newcewizard.fce',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_fcetab.php',
				'class' =>  'tx_templavoila_fcetab'
			),
			'plugins' => array(
				'title' => 'newcewizard.plugins',
				'file' => 'EXT:templavoila/wizards_ce/tabs/class.tx_templavoila_pluginstab.php',
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/index.php']);
}

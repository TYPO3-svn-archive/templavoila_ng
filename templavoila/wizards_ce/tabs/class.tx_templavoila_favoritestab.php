 ...
 *
 * $Id: class.tx_templavoila_favoritestab.php 16722 2009-02-06 19:40:34Z dmitry $
 */
	...
	function getTabContent() {
		...
		$message = sprintf($GLOBALS['LANG']->getLL('newcewizard.no_favorites_yet'),
			'<img ' . t3lib_iconWorks::skinImg($GLOBALS['BACK_PATH'],
					...
					'wizards_ce/images/add_favorite.png') . ' alt="" align="absmiddle" />');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/tabs/class.tx_templavoila_favoritestab.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/tabs/class.tx_templavoila_favoritestab.php']);
}

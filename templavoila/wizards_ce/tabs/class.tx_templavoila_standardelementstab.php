 ...
 *
 * $Id: class.tx_templavoila_standardelementstab.php 16722 2009-02-06 19:40:34Z dmitry $
 */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/tabs/class.tx_templavoila_standardelementstab.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards_ce/tabs/class.tx_templavoila_standardelementstab.php']);
}

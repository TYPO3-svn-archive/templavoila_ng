<?php
# TYPO3 CVS ID: $Id: ext_tables.php 11308 2008-08-21 11:26:27Z dmitry $
...
if (TYPO3_MODE == 'BE') {
	...
	t3lib_extMgm::addModulePath('tx_templavoila_wizards', t3lib_extMgm::extPath($_EXTKEY) . 'wizards/');
	...
	$GLOBALS['TBE_STYLES']['htmlTemplates']['templates/wizard.html'] =
		t3lib_extMgm::extRelPath($_EXTKEY) . 'templates/wizard.html';
...
if ($_EXTCONF['enable.']['selectDataSource']) {
	...
	t3lib_extMgm::addToAllTCAtypes('pages', 'tx_templavoila_ds;;;;1-1-1,tx_templavoila_to,tx_templavoila_nextds;;;;1-1-1,tx_templavoila_next_to', '4');
	...
	t3lib_extMgm::addToAllTCAtypes('pages', 'tx_templavoila_to;;;;1-1-1,tx_templavoila_next_to;;;;1-1-1,tx_templavoila_flex;;;;1-1-1', '1');

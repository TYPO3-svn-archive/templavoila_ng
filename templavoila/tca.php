<?php
# TYPO3 CVS ID: $Id: tca.php 5727 2007-06-21 11:48:12Z dmitry $
	...
	'columns' => Array (
		...
		'datastructure' => Array (
			...
			'config' => Array (
				...
				'minitems' => 0,
				'maxitems' => 1,
                		'itemsProcFunc' => 'tx_templavoila_retrieval->dataStructureItemsProcFunc',
				'allowNonIdValues' => 1,
				'suppress_icons' => 'ONLY_SELECTED',
				'wizards' => Array(
					'_PADDING' => 2,
		...
		'belayout_mtime' => Array ('config' => Array ('type' => 'passthrough')),
		'belayout_md5' => Array ('config' => Array ('type' => 'passthrough')),
...
$TCA['tx_templavoila_datastructure'] = Array (
	...
	'columns' => Array (
		...
		'belayout' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:templavoila/locallang_db.xml:tx_templavoila_datastructure.belayout',
			'config' => Array (
				'type' => 'input',
				'size' => '48',
				'wizards' => Array(
	...
	'types' => Array (
		'0' => Array('showitem' => 'title;;;;2-2-2, belayout, scope, previewicon, dataprot;;;;3-3-3')
	)
);

 ...
 *
 * $Id: class.tx_templavoila_mod1_wizards.php 4964 2007-02-18 17:28:19Z dmitry $
 *
 ...
 */
class tx_templavoila_wizards_page {
...
//		$this->doc->form = '<form action="' . htmlspecialchars('index.php?id=' . $this->pObj->id) . '" method="post" autocomplete="off" enctype="' . $TYPO3_CONF_VARS['SYS']['form_enctype'] . '" onsubmit="return TBE_EDITOR_checkSubmit(1);">';
		...
		$this->doc->JScode .= $tceforms->printNeededJSFunctions_top();
		$this->doc->postCode .= $tceforms->printNeededJSFunctions();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards/class.tx_templavoila_wizards_page.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/templavoila/wizards/class.tx_templavoila_wizards_page.php']);
}
